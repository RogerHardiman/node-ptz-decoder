# Pelco D, Pelco P, BBV422 and Bosch (Philips), Forward Vision and Vicon Telemetry Decoder (node-pelcod-decoder)

This module reads Pelco D, Pelco P, BBV422, Bosch(Philips), Forward Vision and Vicon CCTV Camera Pan/Tilt/Zoom data, validates each command and decodes its meaning.
