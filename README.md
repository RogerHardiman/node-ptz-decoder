...
This module reads Pelco D, Pelco P, BBV422, Bosch(Philips PCSS), Forward Vision, VCL, Vicon, American Dynamics(Sensormatic), JVC, Panasonic and Sony VISCA CCTV Camera Pan/Tilt/Zoom data, validates each command and decodes its meaning.
