# Pelco D and Pelco P, BBV422 and Bosch (Philips) Telemetry Decoder (node-pelcod-decoder)

This module reads Pelco D, Pelco P, BBV422 and Bosch(Philips) CCTV Camera Pan/Tilt/Zoom data, validates each command and decodes its meaning.
