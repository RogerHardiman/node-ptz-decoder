...
0x01,0xFA,0x8A,0xC1,0x08,0xCC,0xFF,0xFC,0xA4,0x47,0x00            // Goto position (Degs)
  ...
  describe("VISCA block of data", function() {
    it("tests VISCA", function() {
      var bytes = [
0x81,0x01,0x06,0x04,0xFF, // Home
0x81,0x01,0x06,0x01,0x00,0x01,0x03,0x01,0xFF, // Up
0x81,0x01,0x06,0x01,0x00,0x01,0x03,0x02,0xFF, // Down 
0x81,0x01,0x06,0x01,0x01,0x00,0x01,0x03,0xFF, // Left 
0x81,0x01,0x06,0x01,0x01,0x00,0x02,0x03,0xFF, // Right 
0x81,0x01,0x06,0x01,0x00,0x00,0x03,0x03,0xFF, // Stop 
0x81,0x01,0x04,0x07,0x00,0xFF, // Zoom Stop 
0x81,0x01,0x04,0x07,0x02,0xFF, // Zoom Tele 
0x81,0x01,0x04,0x07,0x03,0xFF, // Zoom Wide 
0x81,0x01,0x04,0x07,0x27,0xFF, // Zoom Tele with speed 7
0x81,0x01,0x04,0x07,0x37,0xFF, // Zoom Wide with speed 7
0x88,0x30,0x01,0xff,
0x88,0x01,0x00,0x01,0xff,
0x81,0x01,0x04,0x00,0x02,0xff,
0x81,0x01,0x04,0x40,0x00,0x00,0x00,0x02,0xff,
0x81,0x01,0x06,0x06,0x02,0xff,
0x81,0x01,0x06,0x02,0x14,0x18,0x0f,0x0a,0x06,0x00,0x0f,0x0e,0x09,0x08,0xff,
0x81,0x01,0x04,0x3f,0x01,0x00,0xff,
0x81,0x01,0x06,0x02,0x14,0x18,0x00,0x05,0x0a,0x00,0x00,0x01,0x06,0x08,0xff,
0x81,0x01,0x04,0x3f,0x01,0x01,0xff,
0x81,0x01,0x06,0x02,0x14,0x18,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xff,
0x81,0x01,0x04,0x3f,0x01,0x02,0xff,
0x81,0x01,0x04,0x3f,0x02,0x00,0xff,
0x81,0x01,0x04,0x3f,0x02,0x01,0xff,
0x81,0x01,0x04,0x3f,0x02,0x02,0xff,
0x81,0x01,0x04,0x00,0x03,0xff
  ...
  describe("Samsung block of data", function () {
    it("tests garbage then Samsung data", function () {
      var bytes = [


        0xa0, 0x00, 0x01, 0x01, 0x00, 0x01, 0x40, 0x00, 0xbc,  // Cam1  Pan Left
        0xa0, 0x00, 0x01, 0x01, 0x00, 0x02, 0x40, 0x00, 0xbb,  // Cam1  Pan Right
        0xa0, 0x00, 0x01, 0x01, 0x00, 0x04, 0x00, 0x2d, 0xcc,  // Cam1  Tilt Up
        0xa0, 0x00, 0x01, 0x01, 0x00, 0x08, 0x00, 0x2d, 0xc8,  // Cam1  Tilt Down

        0xa0, 0x00, 0x01, 0x01, 0x20, 0x00, 0x00, 0x00, 0xdd,  // Cam1  Zoom In
        0xa0, 0x00, 0x01, 0x01, 0x40, 0x00, 0x00, 0x00, 0xbd,  // Cam1  Zoom Out
        0xa0, 0x00, 0x01, 0x01, 0x02, 0x00, 0x00, 0x00, 0xfb,  // Cam1  Focus Near
        0xa0, 0x00, 0x01, 0x01, 0x01, 0x00, 0x00, 0x00, 0xfc,  // Cam1  Focus Far

        0x0a, 0x00, 0x01, 0x01, 0x08, 0x00, 0x00, 0x00, 0xf5,  // Cam1  Iris open
        0x0a, 0x00, 0x01, 0x01, 0x10, 0x00, 0x00, 0x00, 0xed,  // Cam1  Iris close

        0xa0, 0x00, 0x01, 0x01, 0x00, 0x00, 0x00, 0x00, 0xfd,  // Cam1  Stop

        0xa0, 0x00, 0x0a, 0x01, 0x00, 0x01, 0x40, 0x00, 0xb3,  // Cam10 Pan Left
        0xa0, 0x00, 0x0a, 0x01, 0x00, 0x00, 0x00, 0x00, 0xf4  // Cam10 Stop
      ];
      var buf = new Buffer(bytes);
      pelcod_decoder.processBuffer(buf);
    });
