...
0x86,0x00,0x31,0x07,0x02,0x05,0x45
  ...
  describe("Bosch Telemetry (Philips BiPhase) wipe", function() {
    it("tests PTZ commands", function() {
      var bytes = [
0x87,0x00,0x00,0x05,0x7f,0x78,0x10,0x13,
0x87,0x00,0x00,0x05,0x7f,0x78,0x00,0x03,
0x87,0x00,0x00,0x05,0x00,0x78,0x01,0x05,
0x87,0x00,0x00,0x05,0x00,0x00,0x00,0x0c
      ];
      var buf = new Buffer(bytes);
      pelcod_decoder.processBuffer(buf);
    });
